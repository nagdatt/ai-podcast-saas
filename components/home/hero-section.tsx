...
export async function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden mesh-background">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-20 animate-float">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full glass-card hover-glow mb-8 animate-shimmer">
              ...
              <span className="text-sm font-semibold bg-gradient-to-r from-purple-600 to-purple-500 bg-clip-text text-transparent">
                AI-Powered Podcast Processing
              </span>
            </div>

            <h1 className="text-6xl md:text-7xl lg:text-8xl font-extrabold mb-8 leading-tight">
              <span className="gradient-purple-text">Transform</span> Your
              <br />
              Podcasts with AI
            </h1>
          ...
          {isSignedIn ? (
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <SignInButton mode="modal">
                <Button
                  size="lg"
                  className="gradient-purple text-white hover-glow text-lg px-8 py-6 rounded-xl shadow-lg"
                >
                  Get Started
      ...
      <div
        className="absolute bottom-0 left-0 w-96 h-96 bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float"
